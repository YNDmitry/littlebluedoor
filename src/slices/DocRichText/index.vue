...
const serializer = {
  ...
  heading3: ({ children }: any) =>
    `<h3 class="text-[1.25rem] max-tablet:text-[1rem] mb-[0.9375rem] mt-[1.25rem] uppercase font-[500]">${children}</h3>`,
  heading4: ({ children }: any) =>
    `<h4 class="text-[1rem] max-tablet:text-[0.9rem] my-[0.9375rem]">${children}</h4>`,
