export default {
    ...
    input: () => ({
        class: [
            'min-h-[45px] w-full border-b border-gray-400 bg-transparent rounded-none'
        ]
    }),
    inputicon: {
    ...
    daylabel: ({ context }) => ({
        class: [
            ...
            // Colors
            {
                'text-primary bg-mainColor/[.06]': context.date.today,
                'text-surface-600 bg-transparent': !context.selected && !context.disabled && !context.date.today,
                'bg-mainColor/[.3]': context.selected && !context.disabled
            },

            // States
            'focus:outline-none focus:outline-offset-0 focus:ring focus:ring-primary-400/50',
            {
                'hover:bg-mainColor/[.3]': !context.selected && !context.disabled,
                'hover:bg-mainColor/[.5]': context.selected && !context.disabled
            },
            {
                'opacity-60 cursor-default': context.disabled,
                'cursor-pointer': !context.disabled
    ...
    todaybutton: {
        root: {
            class: [
                ...
                // Colors
                'bg-mainColor border-transparent',
                'text-mainColor',
