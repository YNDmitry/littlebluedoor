<template>
	...
	<section class="pb-[85px] pt-headerHeight">
		...
		<div class="pt-[35px]">
			...
			<div class="mx-auto flex max-w-[677px] flex-col gap-[15px] px-4 pt-[10px] text-[14px]">
				<p class="text-center uppercase">
					Lorem ipsum <b>dolor sit amet,</b> consectetur adipisicing elit. Provident maxime facere
					expedita quia voluptas suscipit reiciendis impedit voluptatibus quidem soluta!
				</p>

				<p class="text-center uppercase">
					Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit itaque ullam similique,
					dolore corporis iste.
				</p>
			</div>
		</div>
	</section>
	...
	<section>
		<div class="mx-auto max-w-[1315px] px-4 pb-5">
			...
			<p class="pt-4 text-center">
				AVOID THE TOURSIT TRAPS AND IMMERSE IN THE <b>TRUE ESSENCE</b> OF EACH DESTINATION
			</p>
			...
			<div class="grid gap-5 pt-8 max-laptop:grid-cols-2 max-tablet:grid-cols-1 laptop:grid-cols-4">
				<div class="flex flex-col gap-[15px] max-laptop:items-center">
					<img class="w-[300px] object-cover" src="/img/ourService.png" alt="" />

					<div class="flex flex-col gap-[10px]">
						<p class="text-center">
							Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati accusamus minima
							nesciunt assumenda qui fugiat commodi nam earum! Ea, dolore!
						</p>
	...
	<section class="max-tablet:pt-[50px] tablet:pt-[100px]">
		<div class="mx-auto max-w-[900px] px-4">
			...
			<p class="pt-4 text-center uppercase">An expert from lbd will contact you shortly</p>
